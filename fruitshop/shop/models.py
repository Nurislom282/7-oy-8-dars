...
class Subcategory(models.Model):
    ...
    category = models.ForeignKey(Ctegory,on_delete=models.CASCADE,related_name='category')
    slug = models.SlugField(max_length=100,unique=True)
...
class ProductVidio(models.Model):
    ...
    product = models.ForeignKey(Product,on_delete=models.CASCADE,related_name='productvidio')
